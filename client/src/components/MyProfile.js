          ...
          <form onSubmit={this.submitChangePassword}>
            ...
            <div className="form-group">
              ...
              <input
                ...
                value={newPassword}
                className={`form-control ${
                  isNewPwdValidated ? 'is-valid' : 'is-invalid'
                }`}
            ...
            <div className="form-group">
              ...
              <input
                ...
                className={`form-control ${
                  isNewRepwdValidated ? 'is-valid' : 'is-invalid'
                }`}
                onChange={this.handleChangeNewRepwd}
              />
            ...
            <div className="modal-content">
              ...
              <div className="modal-footer">
                <button
                  type="button"
                  className="btn btn-danger"
                  onClick={this.onClickDeleteMyAccount}
                  data-dismiss="modal"
                >
                  Delete
                </button>
